        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('produk.update',$produk->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-control">
                                    ...
                                    @foreach ($kategori_produk as $item)
                                        <option @if($item->id == $produk->category_id) selected @endif value="{{ $item->id }}">{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                @error('category_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <img src="{{ asset($produk->thumbnail) }}" width="200px">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group form-group-last">
                                ...
                                <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror"
                                    id="exampleTextarea" rows="3">{{ old('deskripsi',$produk->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
