            ...
            <div class="kt-subheader__toolbar">
                <div class="kt-subheader__wrapper">
                    <div class="dropdown dropdown-inline" data-toggle="kt-tooltip" title="Tambah Data"
                        data-placement="left">
                        <a href="{{ route('portfolio.create') }}" class="btn btn-icon" aria-haspopup="true"
                            aria-expanded="false">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @forelse ($portfolios as $index => $item)
                                            <tr>
                                                <td>{{ ++$index }}</td>
                                                <td><img src="{{ asset($item->file_url) }}" width="100px"></td>
                                                <td>{{ $item->caption }}</td>
                                                <td>{{ $item->order }}</td>
                                                <td>{{ $item->updated_at }}</td>
                                                <td>
                                                    <a href="{{ route('portfolio.edit',$item->id) }}" class="btn btn-sm btn-success"><i class="flaticon-edit"></i></a>
                                                    <button type="button"
                                                        data-url="{{ route('portfolio.destroy', $item->id,['param' => 'delete']) }}"
