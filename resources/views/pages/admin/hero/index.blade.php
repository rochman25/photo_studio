            ...
            <div class="kt-subheader__toolbar">
                <div class="kt-subheader__wrapper">
                    <div class="dropdown dropdown-inline" data-toggle="kt-tooltip" title="Tambah Data"
                        data-placement="left">
                        <a href="{{ route('hero.create') }}" class="btn btn-icon" aria-haspopup="true"
                            aria-expanded="false">
                                    ...
                                    <tbody>
                                        @forelse ($heros as $index => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('hero.edit',$item->id) }}" class="btn btn-sm btn-success"><i class="flaticon-edit"></i></a>
                                                    <button type="button"
                                                        data-url="{{ route('hero.destroy', $item->id,['param'=>'delete']) }}"
