    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
            ...
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item @if (Route::currentRouteName()=='view.home' ) kt-menu__item--active @endif" aria-haspopup="true"><a
                        href="{{ route('view.home') }}" class="kt-menu__link "><span class="kt-menu__link-icon"><svg
                ...
                <li class="kt-menu__item @if (Route::currentRouteName()=='kategori_produk.index'
                    ) kt-menu__item--active @endif" aria-haspopup="true"
                    data-ktmenu-submenu-toggle="hover"><a href="{{ route('kategori_produk.index') }}"
                ...
                <li class="kt-menu__item @if (Route::currentRouteName()=='produk.index' ) kt-menu__item--active @endif" aria-haspopup="true"
                    data-ktmenu-submenu-toggle="hover"><a href="{{ route('produk.index') }}"
                        class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            </svg></span><span class="kt-menu__link-text">Produk</span></a>
                ...
                <li class="kt-menu__item @if (Route::currentRouteName()=='booking.index' ) kt-menu__item--active @endif" aria-haspopup="true"
                    data-ktmenu-submenu-toggle="hover"><a href="{{ route('booking.index') }}"
                        class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="kt-menu__item" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a
                        href="{{ route('schedule.index') }}" class="kt-menu__link kt-menu__toggle"><span
                            ...
                            </svg></span><span class="kt-menu__link-text">Jadwal Booking</span></a>
                ...
                <li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click"
                    aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a
                        class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                            ...
                            </svg></span><span class="kt-menu__link-text">Personalisasi</span><i
                            class="kt-menu__ver-arrow la la-angle-right"></i></a>
                    <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                        <ul class="kt-menu__subnav">
                            <li class="kt-menu__item" aria-haspopup="true"><a href="{{ route('hero.index') }}"
                                    class="kt-menu__link"><i class="kt-menu__link-icon flaticon2-cube-1"></i><span
                                        class="kt-menu__link-text">Banner</span></a>
                            </li>
                            <li class="kt-menu__item" aria-haspopup="true"><a href="{{ route('portfolio.index') }}"
                                    class="kt-menu__link"><i class="kt-menu__link-icon flaticon2-cube-1"></i><span
                                        class="kt-menu__link-text">Portfolio</span></a>
                            </li>
                            <li class="kt-menu__item" aria-haspopup="true"><a href="{{ route('setting.index') }}"
                                    class="kt-menu__link"><i class="kt-menu__link-icon flaticon2-cube-1"></i><span
                                        class="kt-menu__link-text">Pengaturan</span></a>
                            </li>
                </li>
            </ul>
        </div>
        </li>
        <li class="kt-menu__item @if (Route::currentRouteName()=='role.index' ) kt-menu__item--active @endif" aria-haspopup="true"
            data-ktmenu-submenu-toggle="hover"><a href="{{ route('role.index') }}"
                class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                ...
                </span><span class="kt-menu__link-text">Role</span></a>

        </li>
        <li class="kt-menu__item @if (Route::currentRouteName()=='user.index' ) kt-menu__item--active @endif" aria-haspopup="true"
            data-ktmenu-submenu-toggle="hover"><a href="{{ route('user.index') }}"
                class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                        height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                </span><span class="kt-menu__link-text">User</span></a>
