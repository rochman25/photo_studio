    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
            ...
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item @if(Route::currentRouteName() == 'view.home') kt-menu__item--active @endif" aria-haspopup="true"><a href="{{ route('view.home') }}"
                ...
                <li class="kt-menu__item @if(Route::currentRouteName() == 'kategori_produk.index') kt-menu__item--active @endif" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="{{ route('kategori_produk.index') }}"
                ...
                <li class="kt-menu__item @if(Route::currentRouteName() == 'produk.index') kt-menu__item--active @endif" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="{{ route('produk.index') }}"
                        class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="kt-menu__item @if(Route::currentRouteName() == 'booking.index') kt-menu__item--active @endif" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="{{ route('booking.index') }}"
                        class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="kt-menu__item @if(Route::currentRouteName() == 'user.index') kt-menu__item--active @endif" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="{{ route('user.index') }}"
                        class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
